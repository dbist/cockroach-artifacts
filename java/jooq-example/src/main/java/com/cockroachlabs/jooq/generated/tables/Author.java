...
public class Author extends TableImpl<AuthorRecord> {
    ...
    /**
     * The column <code>public.author.first_name_encrypted</code>.
     */
    public final TableField<AuthorRecord, byte[]> FIRST_NAME_ENCRYPTED = createField(DSL.name("first_name_encrypted"), SQLDataType.BLOB, this, "");

    /**
     * The column <code>public.author.last_name_encrypted</code>.
     */
    public final TableField<AuthorRecord, byte[]> LAST_NAME_ENCRYPTED = createField(DSL.name("last_name_encrypted"), SQLDataType.BLOB, this, "");
    ...
    private Author(Name alias, Table<AuthorRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("jooq encryption example."), TableOptions.table());
    }
    ...
    public UniqueKey<AuthorRecord> getPrimaryKey() {
        return Keys.AUTHOR__AUTHOR_PKEY;
    }
     ...
     */
    public <U> SelectField<U> mapping(Function5<? super Long, ? super String, ? super String, ? super byte[], ? super byte[], ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function5<? super Long, ? super String, ? super String, ? super byte[], ? super byte[], ? extends U> from) {
